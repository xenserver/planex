...
class LinkTests(unittest.TestCase):
    ...
    def setUp(self):
        rpm_defines = [("dist", ".el6"),
                       ("_topdir", "_build"),
                       ("_sourcedir", "%_topdir/SOURCES/%name")]
        self.spec = planex.spec.load("tests/data/ocaml-cohttp.spec",
                                     link=Link("tests/data/ocaml-cohttp.lnk"),
                                     defines=rpm_defines)
    ...
    def test_build_srpm_from_spec(self):
        ...
        self.assertEqual(
            ...
            "tests/data/ocaml-cohttp.spec\n"
            "_build/SRPMS/ocaml-cohttp-0.9.8-1.el6.src.rpm: "
            "tests/data/ocaml-cohttp.lnk\n"
            "_build/SRPMS/ocaml-cohttp-0.9.8-1.el6.src.rpm: "
            "_build/SOURCES/ocaml-cohttp/ocaml-cohttp-0.9.8.tar.gz\n"
            "_build/SRPMS/ocaml-cohttp-0.9.8-1.el6.src.rpm: "
            "_build/SOURCES/ocaml-cohttp/ocaml-cohttp-init\n"
            "_build/SRPMS/ocaml-cohttp-0.9.8-1.el6.src.rpm: "
            "_build/SOURCES/ocaml-cohttp/ocaml-cohttp-service\n"
            "_build/SRPMS/ocaml-cohttp-0.9.8-1.el6.src.rpm: "
            "_build/SOURCES/ocaml-cohttp/cohttp0.patch\n"
            "_build/SRPMS/ocaml-cohttp-0.9.8-1.el6.src.rpm: "
            "_build/SOURCES/ocaml-cohttp/cohttp1.patch\n")
